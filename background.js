// Enhanced Background service worker for the LeetCode Git Pusher extension
class BackgroundService {
    ...
    init() {
        ...
        console.log('LeetCode Git Pusher: Background service initialized');
    }
        ...
        try {
            ...
            if (response.status === 404) {
                ...
                const createResponse = await fetch('https://api.github.com/user/repos', {
                    ...
                    body: JSON.stringify({
                        name: repoName,
                        description: '🚀 My LeetCode solutions automatically synced using LeetCode Git Pusher browser extension',
                        private: isPrivate,
                        auto_init: true,
...
This repository contains my LeetCode solutions, automatically synced using the **LeetCode Git Pusher** browser extension.
...
## 🔧 How It Works
This repository is automatically maintained using the [LeetCode Git Pusher](https://github.com) browser extension, which:
...
---
⭐ **Happy Coding!** ⭐  
*Automatically generated by LeetCode Git Pusher Extension*
`;
